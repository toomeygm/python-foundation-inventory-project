...
box1 = tk.Frame(root, width=500, height=600, bg="#3d6466")
...
def get_storage_location(conn):
   with conn:
      cursor = conn.execute(GET_STORAGE_LOCATION).fetchmany(5)
      for row in cursor:
         print(row)
